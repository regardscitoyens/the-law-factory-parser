...
echo '<p>Les données mises à disposition dans ces répertoires sont celles utilisées par <a href="http://lafabriquedelaloi.fr/">La Fabrique de la Loi</a> pour visualiser '$LELA' <a href="http://lafabriquedelaloi.fr/loi.html?loi='$IDLOI'">'$NOMLONG'</a>.</p>' >> HEADER.html
